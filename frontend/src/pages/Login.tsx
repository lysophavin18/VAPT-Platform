    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-white">VAPT Platform</h1>
          <p className="text-gray-400 mt-2">Vulnerability Assessment & Penetration Testing</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="mt-6 text-center text-sm text-gray-500">
            ...
            <p className="font-mono text-xs mt-1">admin@vapt.local / AdminSecure2024!</p>
          </div>
        </div>
      </div>
    </div>
